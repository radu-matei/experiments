...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Sum_return {
    pub r0: GoChan,
    pub r1: GoInterface,
}
#[test]
fn bindgen_test_layout_Sum_return() {
    assert_eq!(
        ::std::mem::size_of::<Sum_return>(),
        24usize,
        concat!("Size of: ", stringify!(Sum_return))
    );
    assert_eq!(
        ::std::mem::align_of::<Sum_return>(),
        8usize,
        concat!("Alignment of ", stringify!(Sum_return))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Sum_return>())).r0 as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Sum_return),
            "::",
            stringify!(r0)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Sum_return>())).r1 as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Sum_return),
...
extern "C" {
    pub fn Sum(p0: GoSlice, p1: GoChan) -> Sum_return;
}
